...
trait Tables {
   ...
   *  @param exportContractDate Database column export_contract_date DBType(VARCHAR), Length(8,true), Default(None)
   ...
   *  @param exportContractMoney Database column export_contract_money DBType(FLOAT), Default(None)
   ...
   *  @param purchaseMoney Database column purchase_money DBType(FLOAT), Default(None)
   ...
   */
  case class ExportContractProgressRow(id: Int, month: Option[String] = None, exportContractDate: Option[String] = None, exportContractNum: Option[String] = None, contractStatus: Option[String] = None, customer: Option[String] = None, country: Option[String] = None, product: Option[String] = None, exportContractMoney: Option[Float] = None, settlementWay: Option[String] = None, latestDeliveryDate: Option[String] = None, transportWay: Option[String] = None, purchaseContractNum: Option[String] = None, purchaseMoney: Option[Float] = None, progressDescription: Option[String] = None, planLeaveFactoryDate: Option[String] = None, planSendDate: Option[String] = None, planArrivalData: Option[String] = None, payDescription: Option[String] = None, comment: Option[String] = None)
  /** GetResult implicit for fetching ExportContractProgressRow objects using plain SQL queries */
  implicit def GetResultExportContractProgressRow(implicit e0: GR[Int], e1: GR[Option[String]], e2: GR[Option[Float]]): GR[ExportContractProgressRow] = GR {
    prs =>
      import prs._
      ExportContractProgressRow.tupled((<<[Int], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[Float], <<?[String], <<?[String], <<?[String], <<?[String], <<?[Float], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String]))
  }
  ...
  class ExportContractProgress(_tableTag: Tag) extends Table[ExportContractProgressRow](_tableTag, "export_contract_progress") {
    ...
    /** Database column export_contract_date DBType(VARCHAR), Length(8,true), Default(None) */
    val exportContractDate: Column[Option[String]] = column[Option[String]]("export_contract_date", O.Length(8, varying = true), O.Default(None))
    ...
    /** Database column export_contract_money DBType(FLOAT), Default(None) */
    val exportContractMoney: Column[Option[Float]] = column[Option[Float]]("export_contract_money", O.Default(None))
    ...
    /** Database column purchase_money DBType(FLOAT), Default(None) */
    val purchaseMoney: Column[Option[Float]] = column[Option[Float]]("purchase_money", O.Default(None))
